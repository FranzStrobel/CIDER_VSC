package VSC_FZ
  package Testes
    ...
    model D_D_Transformer
      ...
      Modelica.Electrical.Analog.Ideal.IdealTransformer transformer(n = trans_ratio) annotation(
      ...
      Modelica.Electrical.Analog.Sensors.VoltageSensor v1D annotation(
        Placement(visible = true, transformation(origin = {20, 37}, extent = {{7, -7}, {-7, 7}}, rotation = 0)));
  ...
  Modelica.Electrical.Analog.Basic.Ground ground1 annotation(
    ...
    equation
      ...
      connect(v1d.p, transformer.p1) annotation(
        Line(points = {{-34, 36}, {-42, 36}, {-42, 50}, {-12, 50}, {-12, 64}}, color = {0, 0, 255}));
      connect(v1d.n, transformer.n1) annotation(
        Line(points = {{-20, 36}, {-12, 36}, {-12, 44}}, color = {0, 0, 255}));
      connect(v1D.p, transformer.p2) annotation(
        Line(points = {{28, 38}, {28, 50}, {8, 50}, {8, 64}}, color = {0, 0, 255}));
      connect(transformer.n2, v1D.n) annotation(
        Line(points = {{8, 44}, {12, 44}, {12, 38}, {14, 38}}, color = {0, 0, 255}));
  ...
  connect(voltageSensor1.p, resistor1.p) annotation(
        Line(points = {{34, 94}, {22, 94}, {22, 64}}, color = {0, 0, 255}));
    end D_D_Transformer;
    ...
    model DSOGI_PLL
      ...
      VSC_FZ.Testes.PLL_fz2 pLL_fz2 annotation(
    ...
    model COBEP_1
      ...
      // grid parameters
      parameter Real Rr = 4.3;
      parameter Real Lr = 1.5e-2;
      ...
      Modelica.Electrical.Analog.Sources.SineVoltage sineVoltage(V = 11.398e3, freqHz = 60) annotation(
        Placement(visible = true, transformation(origin = {453, 39}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      ...
      Modelica.Electrical.Analog.Sources.SineVoltage sineVoltage1(V = 11.398e3, freqHz = 60, phase = -2.094395102393195) annotation(
        Placement(visible = true, transformation(origin = {455, -22}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      Modelica.Electrical.Analog.Sources.SineVoltage sineVoltage2(V = 11.398e3, freqHz = 60, phase = 2.094395102393195) annotation(
  ...
  Modelica.Blocks.Math.Division division2 annotation(
        Placement(visible = true, transformation(origin = {58, 312}, extent = {{-7, -7}, {7, 7}}, rotation = 0)));
  ...
  Modelica.Blocks.Sources.Constant constant17(k = 54.14) annotation(
        Placement(visible = true, transformation(origin = {21, 240}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Sources.Ramp ramp(duration = 0.395, height = 750e3, startTime = 0.4)  annotation(
        Placement(visible = true, transformation(origin = {38, 170}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  Modelica.Blocks.Sources.Constant constant18(k = 915e3) annotation(
        Placement(visible = true, transformation(origin = {114, 60}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  Modelica.Blocks.Sources.Constant constant12(k = 11.26765e3) annotation(
        Placement(visible = true, transformation(origin = {594, 98}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Sources.RealExpression realExpression20(y = pca.v) annotation(
    ...
    equation
      ...
      connect(sineVoltage.n, ground1.p) annotation(
        Line(points = {{463, 39}, {463, 38}, {480, 38}, {480, -22}}, color = {0, 0, 255}));
      ...
      connect(inductor3.n, sineVoltage.p) annotation(
        Line(points = {{432, 39}, {432, 40}, {443, 40}, {443, 39}}, color = {0, 0, 255}));
      ...
      connect(realExpression49.y, division2.u1) annotation(
        Line(points = {{12, 303}, {27, 303}, {27, 316}, {50, 316}}, color = {0, 0, 127}));
      ...
      connect(constant17.y, division2.u2) annotation(
        Line(points = {{32, 240}, {40, 240}, {40, 308}, {50, 308}}, color = {0, 0, 127}));
      connect(ramp.y, Controle_potencia.P_ref) annotation(
        Line(points = {{49, 170}, {81, 170}, {81, 113}, {89, 113}}, color = {0, 0, 127}));
      connect(ramp.y, Pref_pu.u1) annotation(
        Line(points = {{49, 170}, {115, 170}, {115, 163}, {122, 163}}, color = {0, 0, 127}));
      connect(ramp1.y, Controle_potencia.Q_ref) annotation(
        Line(points = {{85, 68}, {84, 68}, {84, 94}, {89, 94}}, color = {0, 0, 127}));
      connect(constant18.y, Qref_pu.u2) annotation(
        Line(points = {{125, 60}, {130, 60}, {130, 72}, {139, 72}}, color = {0, 0, 127}));
      connect(ramp1.y, Qref_pu.u1) annotation(
        Line(points = {{85, 68}, {96, 68}, {96, 80}, {139, 80}}, color = {0, 0, 127}));
  connect(constant12.y, pca_pu.u2) annotation(
        Line(points = {{605, 98}, {610, 98}, {610, 108}, {619, 108}}, color = {0, 0, 127}));
